...
export const metadata: Metadata = {
  ...
  openGraph: {
    title: 'VAT Faktura - Faktury, PIT, ZUS, Urzedy i Porady Online | KSEF',
    description: 'Kompleksowy program: 5 faktur za darmo, Premium 99 PLN/msc. Rozliczenie PIT-37/36/28/38, formularze ZUS, zaloz firme, wyszukiwarka urzedow. KSEF.',
    ...
    images: [
      {
        ...
        width: 1200,
        height: 630,
        alt: 'VAT Faktura - Faktury, PIT, ZUS i Zaloz Firme Online',
      },
    ],
  },
  twitter: {
    card: 'summary_large_image',
    title: 'VAT Faktura - Faktury, PIT, ZUS, Urzedy i Porady',
    description: 'Program all-in-one: 5 faktur za darmo, Premium 99 PLN/msc. PIT + ZUS + rejestracja firmy + wyszukiwarka urzedow. Platnosc PayPal.',
    creator: '@vatfaktura',
  },
