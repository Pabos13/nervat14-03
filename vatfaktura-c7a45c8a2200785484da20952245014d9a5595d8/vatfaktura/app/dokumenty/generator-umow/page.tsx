        ...
        <main className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 py-12 sm:py-16">
          ...
          <div className="mb-12">
            <div className="flex items-center gap-3 mb-4">
              ...
              <h1 className="text-4xl sm:text-5xl font-bold bg-gradient-to-r from-green-400 via-emerald-300 to-green-300 bg-clip-text text-transparent">
                Generator Umów i Dokumentów
              </h1>
            </div>
            <p className="text-lg text-blue-200/70 max-w-2xl">
              Generuj profesjonalne umowy, regulaminy i dokumenty biznesowe. Szablony dostosowywane do Twoich potrzeb.
            </p>
          </div>
          ...
          <div className="mt-12 grid grid-cols-1 md:grid-cols-2 gap-6">
            <div className="bg-blue-600/15 border border-blue-500/30 rounded-lg p-6">
              <h3 className="font-bold text-blue-300 mb-4">Dostępne szablony:</h3>
              <ul className="space-y-2 text-blue-200/70 text-sm">
                <li>✓ Umowa B2B - Umowa o pracę</li>
            ...
            <div className="bg-green-600/15 border border-green-500/30 rounded-lg p-6">
              <h3 className="font-bold text-green-300 mb-4">Jak korzystać:</h3>
              <ul className="space-y-2 text-green-200/70 text-sm">
                <li>1. Wybierz szablon dokumentu</li>
                <li>2. Uzupełnij wszystkie wymagane pola</li>
                <li>3. Podgląd dokumentu</li>
                <li>4. Pobierz lub skopiuj do schowka</li>
                <li>5. Edytuj w swoim edytorze tekstu</li>
              </ul>
            </div>
          </div>
        </main>
